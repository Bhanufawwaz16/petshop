      ...
      {tabs.find((tab) => tab.current && tab.name === "My Account") && (
        ...
        >
          ...
          <div className="flex-row">
            <h2 className="text-left font-black text-xl my-3 text-blue-800">
              Users Profile
            </h2>
          </div>
              ...
              <div className="w-1/2 border-r-4">
                <div className="space-y-4">
                  <div className="aspect-w-3 aspect-h-2">
                    <img
                      className="rounded-lg object-cover shadow-lg w-3/4 items-center"
                      src={
              ...
              <div className="ml-3">
                ...
                <p className="my-3 ml-3">
                  ...
                  <span className="ml-14">
                    {convertToDate(user.birthdate)}
                  </span>{" "}
                </p>

                <p className="my-3 ml-3">
                  Address
                  <span className="ml-14">{user.addres}</span>{" "}
                </p>
                ...
                <p className="my-3 ml-3">
                  Phone<span className="ml-20">{user.phone}</span>{" "}
                </p>
