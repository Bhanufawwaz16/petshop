                  ...
                  <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900">{value.m_product.name}</p>
                        <p className="mt-1 text-sm  text-gray-900 font-semibold">Total: </p>
                        <p className="mt-1 text-sm font-medium text-gray-900">{numToIDRCurrency(value.m_product.price*value.qty)}</p>
                      </div>
