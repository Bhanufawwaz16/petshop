...
export default function ListCart({ productCart = [] }) {
  console.log("list cart", productCart);
  return (
              ...
              {productCart.map((product) => (
                <li key={product.id} className="flex py-6">
                  <div className="flex-shrink-0">
                    <img
                      src={`${process.env.REACT_APP_PRODUCT_IMG_BASE_URL}/${product.m_product.image_url}`}
                      alt={product.m_product.name}
