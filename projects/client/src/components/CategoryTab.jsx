...
const CategoryTab = ({ className }) => {
  return (
    <div className={`py-3 ${className}`}>
      <h2 className="my-8 sm:flex sm:items-center text-2xl tracking-tight md:text-3xl lg:text-4xl text-black-500 font-bold sm:after:block sm:after:h-[1px] sm:after:bg-gray-200 sm:after:flex-grow sm:after:ml-4">
        Selected Categories<span className="text-black-700">.</span>
      </h2>
